		   ...
		   <input type="hidden" name="id" value="${stu.id}">
			...
			<div class="login-fields">
				<div class="field">
					...
					<input type="text" id="firstname" name="student.name" class="login" />
				</div> <!-- /field -->
				
				<div class="field">
				    <b>性别:</b>			
					<label for="lastname">Last Name:</label>	
					<input type="text" id="lastname" name="student.sex" class="login" />
				...
				<div class="field">
				   <b>数学:</b>
					...
					<input type="text" id="email" name="student.math" class=""/>
				</div> <!-- /field -->
				
				<div class="field">
				    <b>英语:</b>
					<label for="password">Password:</label>
					<input type="text" id="password" name="student.english" class="login"/>
				</div> <!-- /field -->
				...
				<div class="field">
					...
					<br>
					<input type="text" id="password" name="student.chinese" class="login"/>
				</div> <!-- /field -->
