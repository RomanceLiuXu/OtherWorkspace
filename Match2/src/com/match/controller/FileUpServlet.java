		...
		try {
			...
			for (FileItem fileItem : fileItems) {
				...
				if (uid != 0) {
					...
					//res.sendRedirect("jsp/photoupsuccess.jsp?paddress=" + paddress);
					req.setAttribute("paddress", paddress);
					req.getRequestDispatcher("jsp/photoupsuccess.jsp?").forward(req, res);
					break;
				}
