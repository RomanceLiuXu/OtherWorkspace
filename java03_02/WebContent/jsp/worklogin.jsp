...
<html>
	...
	<body>
		<form action="<%=basePath %>loginw" method="post">
			<div class="class1">
				<span>QQ登录</span>
				<div class="class2">
					账号:
					<input type="text" name="lcode" placeholder="输入账号" style="width: 140px; height: 20px;" />
					<br />
					<br /> 密码:
					<input type="password" name="lpsw" placeholder="输入密码" style="width: 140px; height: 20px;" />
					<br />
