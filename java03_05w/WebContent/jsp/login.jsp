...
<html>
	...
	<body>
		<form action="http://localhost:8080/java03_05w/user_login" method="post">
			<div class="class1">
				<span>QQ登录</span>
				<div class="class2">
					账号:
					<input type="text" name="user.name" placeholder="输入账号" style="width: 140px; height: 20px;" />
					<br />
					<br /> 密码:
					<input type="password" name="user.psw" placeholder="输入密码" style="width: 140px; height: 20px;" />
					<br />
